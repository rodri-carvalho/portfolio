	...
	return (
		<>
				...
				<div className="mockup-browser bg-accent border ">
					<div className="mockup-browser-toolbar gap-2 lg:gap-4 2xl:gap-6 3xl:gap-8 4xl:gap-10 text-base-100">
						<div className="campo flex justify-start w-3/4 md:w-full 3xl:ml-12 4xl:ml-16">
							<div className="input !bg-secondary !flex !m-0 2xl:py-6 3xl:py-8 4xl:py-14 items-center md:!w-8/12 xl:!w-7/12 4xl:!w-4/12 text-xs md:text-base lg:text-lg 2xl:text-2xl 3xl:text-4xl 4xl:text-5xl">
								{projectURL}
							</div>
						</div>
					</div>
			...
			<dialog id={modalId} ref={modalRef} className="modal">
				<div className="modal-box max-w-full 3xl:w-4/6 flex flex-col items-center p-3 md:p-6 lg:p-8 2xl:p-9 3xl:p-14 4xl:p-16 2xl:rounded-3xl bg-neutral">
					<img
						src={projectPic}
							...
							<div className="flex flex-col items-center gap-4 w-full">
								<div className="w-full flex justify-center">
									<Link
										to={projectURL}
										target="_blank"
										className="btn botao w-3/5 md:w-2/5 lg:w-2/6 2xl:w-1/4 text-lg md:text-2xl lg:text-3xl 2xl:text-4xl 3xl:text-5xl 4xl:text-6xl lg:min-h-14 2xl:min-h-16 3xl:min-h-20 4xl:min-h-32 2xl:rounded-2xl 4xl:rounded-3xl bg-accent text-base-100">
										Visitar Projeto
									</Link>
								</div>
								<button className="btn botao p-0 w-2/5 md:w-1/5 2xl:w-1/6 text-base md:text-xl lg:text-2xl 2xl:text-3xl 3xl:text-4xl 4xl:text-5xl 3xl:min-h-16 4xl:min-h-24 2xl:my-3 3xl:mt-5 2xl:rounded-2xl 4xl:rounded-3xl bg-accent text-base-100">
