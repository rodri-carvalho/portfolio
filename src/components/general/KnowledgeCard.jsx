...
function KnowledgeCard({ iconId, techId, inProgress, techList }) {
	...
	return (
		<>
			<button
				className={`card bg-base-100 shadow-xl p-1 flex justify-center items-center max-h-fit 3xl:m-3 4xl:m-5 ${
				...
				{inProgress && (
					<div className="indicator flex absolute">
						<span className="indicator-item badge h-fit badge-primary 2xl:text-2xl 25xl:text-3xl 4xl:text-5xl py-2 px-5">
							Em andamento
						</span>
					</div>
				)}
				...
				<div className="modal-box pt-4 lg:max-w-fit 25xl:pl-14">
					...
					<div className="modal-action w-full mt-5 md:mt-10 md:mb-3">
						<form method="dialog" className="w-full flex justify-center items-center">
							<button className="btn p-1 w-2/6 text-base md:text-2xl 2xl:text-3xl 25xl:text-4xl 4xl:text-6xl 4xl:h-24 4xl:rounded-2xl">
								Fechar
							</button>
						</form>
					</div>
