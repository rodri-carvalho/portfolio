...
function EducationCard({ institution, title, pic, certificate, index, content = "" }) {
	...
	return (
		<>
			<div className="card bg-secondary image-full w-fit 2xl:w-full lg:96 md:h-auto shadow-xl flex flex-col justify-between 3xl:mx-10">
				...
				<div className="card-body py-6 px-4 flex flex-col !w-full !text-base-100">
					...
					<div className="card-actions justify-end h-full mr-4 3xl:h-full 3xl:flex 3xl:items-end">
						<button
							className="btn h-fit flex self-end w-fit px-5 py-2 mt-5 bottom-5 text-base sm:text-2xl 2xl:text-3xl 3xl:text-4xl sm:mr-6 sm:mb-6 md:mr-0 md:mb-0 lg:p-4 2xl:mr-10 3xl:mr-16 3xl:mb-10 2xl:p-3 3xl:p-7 2xl:rounded-2xl !text-base-100"
						...
						<dialog
							...
							<div className="modal-box !bg-accent 2xl:rounded-3xl md:!max-w-full md:w-10/12 2xl:w-7/12 md:h-fit">
								<img
									src={certificate}
								...
								<div className="modal-action justify-center 2xl:mt-0">
									<form method="dialog" className=" w-full flex justify-center">
										<button className="btn 2xl:rounded-xl !p-0 !min-w-fit w-1/5 text-base md:text-2xl lg:text-2xl xl:text-3xl 3xl:text-4xl 4xl:text-6xl 3xl:min-h-14 4xl:min-h-24 text-base-100">
											Fechar
										</button>
									</form>
								</div>
