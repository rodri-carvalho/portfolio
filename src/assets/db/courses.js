const courses = [
	{
		...
		description:
			"Este treinamento proporcionou uma imersão completa no desenvolvimento web full stack, capacitando-me a criar aplicações web modernas, robustas e escaláveis. Ao longo do curso extensivo com mentoria, aprendi a aplicar uma ampla gama de tecnologias e práticas essenciais, tanto no front-end quanto no back-end. O treinamento e mentoria foram cuidadosamente elaborados para me preparar para enfrentar os desafios do mercado de trabalho e para a criação soluções web inovadoras.",
		learned:
			"• HTML5; • CSS3; • GIT/GITHUB; • Testes com JEST; • React; • Context; • Redux; • Typescript; • SQL; • HTTP; • Express; • Deploy; • Clean Code;",
		pic: "src/assets/pics/logos/dev_quest.jpg",
		inProgress: false,
	...
	},
	{
		...
		description:
			"Neste curso de Node.js, estou aprendendo a usar uma das linguagens de programação mais modernas e requisitadas para o desenvolvimento de backend. O curso abrange desde os conceitos básicos até os mais avançados de Node.js, me permitindo construir aplicações web modernas e escaláveis, além de trabalhar com bancos de dados SQL e MongoDB. A proposta é do desenvolvimento de duas grandes aplicações práticas, que me proporcionarão uma experiência realista e aprofundada. Também explorarei o ecossistema do Node.js e aprenderei a criar aplicações renderizadas no servidor, APIs REST e APIs GraphQL, bem como terei uma introdução ao DenoJS.",
		learned:
...

	{
		...
		description:
			"Neste curso de React, aprendi desde os fundamentos básicos até conceitos avançados, cobrindo aspectos essenciais como componentes, hooks, props e state. Explorei o uso de APIs de terceiros, trabalhei com Firebase 9 para autenticação, consultas Firestore e armazenamento de arquivos, e desenvolvi habilidades em Redux e Redux Toolkit. O curso também abordou animações básicas com Framer Motion, implementação de mapas com Leaflet, sliders com Swiper, e criação de APIs REST. Além disso, tive a oportunidade de aprender a implantar aplicações React em Vercel e Netlify, bem como a manejar o estado global com Context, Reducers e hooks. Foi sem dúvidas uma base sólida para avançar para tópicos mais avançados em MERN.",
		learned:
	...
	},
	{
		...
		description:
			"Neste curso de JavaScript, aprendi desde os fundamentos básicos como tipos de dados, funções e loops, até conceitos avançados como manipulação do DOM, JavaScript assíncrono com promises e async/await. Explorei a fundo como o JavaScript funciona internamente, incluindo contexto de execução, call stack e loop de eventos. Aprendi sobre ferramentas de desenvolvimento como Webpack e como criar um ambiente de desenvolvimento moderno. O curso também abordou estruturas de dados, orientação a objetos, tratamento de erros, Web e Browser APIs, além de testes unitários com Jest. Aprendi o desenvolvimento completo de uma API com Node.js e Express, juntamente com um frontend usando Webpack.",
		learned:
...

	{
		...
		description:
			"Neste curso estão sendo ensinados recuros avançados dessa poderosa extensão do JavaScript. Exploro como o TypeScript melhora o código JavaScript, ajuda a evitar erros e bugs, e como ele é amplamente adotado por grandes bibliotecas e frameworks, como Angular e React. O curso cobre tipos e como usá-los, o funcionamento do compilador TypeScript, recursos do ES6, classes, namespaces, módulos, interfaces, generics e decorators. Estou aprendendo a integrar bibliotecas JavaScript de terceiros em projetos TypeScript e a configurar workflows com TypeScript e Webpack. Também estou praticando a aplicação do TypeScript em projetos reais, tanto com React quanto com Node/Express, através de exercícios e estudos de caso, o que me proporciona uma compreensão prática detalhada das vantagens e funcionalidades dessa linguagem.",
		learned:
	...
	},
	{
		...
		description:
			"Neste curso prático, aprendi a criar layouts impressionantes usando o framework Tailwind CSS e a trabalhar de forma eficiente com classes utilitárias, em contraste com frameworks baseados em componentes como DaisyUI e Bootstrap. Desenvolvi habilidades para criar e editar layouts de forma rápida, construir mini-projetos e projetos inteiros de sites, e configurar um ambiente de desenvolvimento usando o Tailwind. Além disso, aprendi a personalizar estilos para criar layouts sob medida, aplicando as técnicas e ferramentas aprendidas nos vários exemplos de projetos reais explorados.",
		learned:
