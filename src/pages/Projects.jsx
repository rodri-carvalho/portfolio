...
function Projects() {
	...
	return (
		<div className="flex flex-col w-full px-5 sm:px-9 md:px-10 lg:px-14 25xl:px-20 3xl:px-24 3xl:px-32 3xl:py-8 gap-3 sm:gap-6 md:gap-7 lg:gap-8 xl:gap-9 2xl:gap-10 25xl:gap-12 3xl:gap-16 4xl:gap-20">
			...
			<div
				...
				<div
					className={`${
						isMoreProjects
							? "collapse-title max-w-full w-full xl:w-11/12 flex text-xl sm:text-2xl md:text-3xl lg:text-4xl 2xl:text-4xl 3xl:text-6xl pr-4 xxs:ml-2 xs:ml-0 2xl:ml-16 3xl:ml-24 4xl:ml-32 lg:mt-4 2xl:mt-6 3xl:mt-8 4xl:mt-10"
					...
					{visibleProjects < moreProjects.length && (
						<div className="flex items-center justify-center mt-4">
							<button
								...
								className="btn-ghost flex flex-col items-center w-9/12 md:w-1/2 lg:w-5/12 2xl:w-3/12 4xl:w-2/12 text-2xl lg:text-3xl 2xl:text-4xl 3xl:text-5xl 4xl:text-6xl md:mt-3 2xl:mt-5 3xl:mt-6 4xl:mt-8">
								Carregar mais
